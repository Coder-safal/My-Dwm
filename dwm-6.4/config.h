...
MesloLGM Nerd Font Mono:style=Italic
MesloLGM Nerd Font:style=Bold
MesloLGM Nerd Font Propo:style=Bold Italic
MesloLGM Nerd Font Propo:style=Bold
MesloLGM Nerd Font Propo:style=Italic
MesloLGM Nerd Font Mono:style=Regular
MesloLGM Nerd Font Mono:style=Bold Italic
MesloLGM Nerd Font Propo:style=Italic
MesloLGM Nerd Font:style=Bold Italic
MesloLGM Nerd Font Mono:style=Bold
MesloLGM Nerd Font:style=Italic
MesloLGM Nerd Font Mono:style=Regular
MesloLGM Nerd Font Propo:style=Regular
MesloLGM Nerd Font Propo:style=Bold Italic
MesloLGM Nerd Font:style=Italic
MesloLGM Nerd Font:style=Regular
MesloLGM Nerd Font Mono:style=Bold
MesloLGM Nerd Font Propo:style=Regular
MesloLGM Nerd Font Propo:style=Bold
MesloLGM Nerd Font:style=Bold Italic
...
static const char *tags[] = {"1","2","3","4","5","m","7"};
...
static const char *fileexp[]  	= {"nemo",NULL};
...
static const Key keys[] = {
  ...
  { Mod4Mask,                   XK_f,                     togglescratch,  {.ui = 2 } },
    ...
    { 0,               XF86XK_AudioLowerVolume,spawn,          {.v = (const char*[]){ "/usr/bin/bash", "-c","~/scripts/change vdown",NULL } }},
    { 0,               XF86XK_AudioRaiseVolume,spawn,          {.v = (const char*[]){ "/usr/bin/bash", "-c","~/scripts/change vup",NULL } }},
